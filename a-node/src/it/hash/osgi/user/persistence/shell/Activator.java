...
public class Activator extends DependencyActivatorBase {
    ...
    public synchronized void init(BundleContext context, DependencyManager manager) throws Exception {
		...
		props.put(CommandProcessor.COMMAND_SCOPE, "userp");
		props.put(CommandProcessor.COMMAND_FUNCTION, new String[] {"list", "adduser", "listuser", "getusermail","getuser", "removeuser", "updateuser", "login", "loginOA", "validate"});
