...
public class Validator {
	static final String BUSINESSNAME_DEFAULT_RULE = "^([a-z]|[0-9]|\\.){4,32}$";
	...
	private String businessnameRule = BUSINESSNAME_DEFAULT_RULE;
	private String passwordRule = BUSINESSNAME_DEFAULT_RULE;
	private String emailRule = BUSINESSNAME_DEFAULT_RULE;
	private String mobileRule = BUSINESSNAME_DEFAULT_RULE;
	
	Pattern usernamePattern = Pattern.compile(BUSINESSNAME_DEFAULT_RULE);
