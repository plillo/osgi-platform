package a_node_UUIDService_Test;
...
public class MongoTest extends BaseOSGiServiceTest<UUIDService> {
	...
	public void setUp() throws Exception {
		...
		if (uuid.isEmpty()) {
			...
			System.out.println(uuid.get(uuid.size() - 1));
		}
...
@Test
	public void testCreateUUID() throws Exception {
		...
		System.out.println("false - "+uuidS.isEmpty());
		
		assertEquals(false, uuidS.isEmpty());
	}
@Test
...
public void testListType() {
		...
		List<String> list = instance.listType();
