...
public class StringTools {
	...
	public StringTools(String theString) {
	...
	public String trimWords(int size) {
		if(_string==null) return "";

		return trimWords(_string, size);
	}
	...
	public static String trimWords(String s, int size, String suffix) {
		...
		if(size>=s.length()) return s.trim();
	...
	public static Vector<String> wrapWords(String s, int size) {
		...
		do {
			String line = trimWords(s.trim(), size);
			if(line.equals(s)) {
				lines.add(line);
				break;
			}
